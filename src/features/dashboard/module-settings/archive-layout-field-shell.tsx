        ...
        <>
          ...
          <div className="min-h-0 flex-1">
            <textarea
              ...
              className={`${shadcnTextareaClass} min-h-0 pointer-events-none resize-none bg-white text-[12px] text-slate-600 shadow-none dark:bg-slate-950 dark:text-slate-200`}
